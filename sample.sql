...
insert into Members values(1, '남길동', '$2a$10$QjujPoviFdKAx1MCm6qVMOu0cyaNnnEA9Fyja7ZfV6jHyJlYlvRfm');
insert into Members values(2, '남석환', '$2a$10$.dTe8.4ZxdU0WL3wAgCsEuvKNBpyiCKyeoEwIDycq16JCoVadMguK');
insert into Members values(3, '박한나', '$2a$10$KL0R9LMyzG/ZU0x5MfzyYOJMeEcqqP.Lln5egnx7Mf.nMVrXYGlLe');
insert into Members values(4, '남기준', '$2a$10$upyJAcBPo8C03VcGvhqOtuvMFZae1Gzc7Tqkref50bJtmj07qasPK');
insert into Members values(5, '이주은', '$2a$10$CQYkaC7sHq/6yPQHNlDriOtc/xHJXko7x..D1X6VQI3muIl8vJN.G');
insert into Members values(6, '이선미', '$2a$10$zzTRZNS/ubYOB7MC8uWGnOqJWJuJ1i.ld899BJMby0JPtHTrwATUS');
insert into Members values(7, '남기석', '$2a$10$XKC97urk08kSs5UmqX6LBOe/87ZsHZmiBsnvv9yFHN1TRhncHsPpO');
insert into Members values(0, '관리자', '$2a$10$QjujPoviFdKAx1MCm6qVMOu0cyaNnnEA9Fyja7ZfV6jHyJlYlvRfm');

insert into Authroties values(1, 'ROLE_GUEST');
insert into Authroties values(2, 'ROLE_GUEST');
insert into Authroties values(3, 'ROLE_GUEST');
insert into Authroties values(4, 'ROLE_GUEST');
insert into Authroties values(5, 'ROLE_GUEST');
insert into Authroties values(6, 'ROLE_GUEST');
insert into Authroties values(7, 'ROLE_GUEST');
insert into Authroties values(0, 'ROLE_ADMIN');
